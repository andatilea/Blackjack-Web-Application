...
var $author$project$Card$cardValue = function (card) {
	switch (card.a.$) {
		case 'Two':
			var _v1 = card.a;
			return A2($elm$core$List$cons, 2, _List_Nil);
		case 'Three':
			var _v2 = card.a;
			return A2($elm$core$List$cons, 3, _List_Nil);
		case 'Four':
			var _v3 = card.a;
			return A2($elm$core$List$cons, 4, _List_Nil);
		case 'Five':
			var _v4 = card.a;
			return A2($elm$core$List$cons, 5, _List_Nil);
		case 'Six':
			var _v5 = card.a;
			return A2($elm$core$List$cons, 6, _List_Nil);
		case 'Seven':
			var _v6 = card.a;
			return A2($elm$core$List$cons, 7, _List_Nil);
		case 'Eight':
			var _v7 = card.a;
			return A2($elm$core$List$cons, 8, _List_Nil);
		case 'Nine':
			var _v8 = card.a;
			return A2($elm$core$List$cons, 9, _List_Nil);
		case 'Ten':
			var _v9 = card.a;
			return A2($elm$core$List$cons, 10, _List_Nil);
		case 'Jack':
			var _v10 = card.a;
			return A2($elm$core$List$cons, 10, _List_Nil);
		case 'Queen':
		...
		default:
			...
			return A2(
				$elm$core$List$cons,
				1,
				A2($elm$core$List$cons, 11, _List_Nil));
	}
};
var $author$project$Main$getAceFree = function (cards) {
	if (!cards.b) {
		return _List_Nil;
	} else {
		var x = cards.a;
		...
		if (x.a.$ === 'Ace') {
			...
			return _Utils_ap(
				_List_Nil,
				$author$project$Main$getAceFree(xs));
		} else {
			return _Utils_ap(
				$author$project$Card$cardValue(x),
				$author$project$Main$getAceFree(xs));
		}
	}
};
		...
		function (card, acc) {
			if (card.a.$ === 'Ace') {
				...
				return ((A3(
					...
					$elm$core$Basics$add,
					0,
					$author$project$Main$getAceFree(cards)) + 11) > 21) ? (acc + 1) : (acc + 11);
			} else {
				return acc + A3(
					$elm$core$List$foldl,
					$elm$core$Basics$add,
					0,
					$author$project$Card$cardValue(card));
			}
		});
	return A3($elm$core$List$foldl, scoreHelper, 0, cards);
};
...
var $author$project$Test$Generated$Main1400433708$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		globs: _List_Nil,
		paths: _List_fromArray(
			['C:\\Users\\user\\Desktop\\Project_Elm\\tests\\Tests.elm']),
		processes: 4,
		report: $author$project$Test$Reporter$Reporter$JsonReport,
		runs: $elm$core$Maybe$Nothing,
		seed: 307661243572029
	},
...
_Platform_export({'Test':{'Generated':{'Main1400433708':{'init':$author$project$Test$Generated$Main1400433708$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "\\\\.\\pipe\\elm_test-13772-1";
